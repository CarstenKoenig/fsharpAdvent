...
type ProvidedTypeDefinition(container:TypeContainer,className : string, baseType  : Type option) as this =
    ...
    do match container with
       | TypeContainer.Namespace _ -> System.Diagnostics.Debug.WriteLine (sprintf "Creating ProvidedTypeDefinition %s [%d]" className (System.Runtime.CompilerServices.RuntimeHelpers.GetHashCode this))
       | _ -> ()
